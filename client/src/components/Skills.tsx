        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div>
            <img
              ...
              className="rounded-2xl shadow-lg w-full mb-4 lg:mb-6"
            />
              ...
              <div className="grid grid-cols-2 gap-3 lg:gap-4">
                {technicalSkills.map((skill, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="bg-light-gray dark:bg-gray-800 p-3 lg:p-4 rounded-lg text-center hover:bg-navy dark:hover:bg-blue-600 hover:text-white transition-all duration-300 group border dark:border-gray-700"
                    >
                      <IconComponent className="w-6 h-6 lg:w-8 lg:h-8 mx-auto mb-2 text-charcoal dark:text-gray-300 group-hover:text-white" />

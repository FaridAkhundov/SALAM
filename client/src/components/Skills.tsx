          ...
          <div>
            <div className="mb-4 lg:mb-6 animate-on-scroll animation-delay-400">
              <img
                ...
                className="rounded-2xl shadow-lg w-full hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-blue-400 dark:hover:border-blue-500"
              />
            </div>

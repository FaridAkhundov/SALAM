  ...
  return (
    <section ref={sectionRef} id="skills" className="py-12 lg:py-20 bg-white dark:bg-gray-900">
      <div className="max-w-4xl lg:max-w-6xl mx-auto px-4 lg:px-6">
        <div className={`text-center mb-8 lg:mb-16 transition-all duration-800 ${
          ...
          <p className="text-lg lg:text-xl text-charcoal dark:text-gray-300 transition-all duration-800 delay-200">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          <div>
            <div className={`mb-4 lg:mb-6 transition-all duration-800 delay-300 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              <img
            ...
            <div className={`bg-light-gray dark:bg-gray-800 p-4 lg:p-6 rounded-xl border dark:border-gray-700 hover-glow transition-all duration-800 delay-500 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              ...
              <div className="grid grid-cols-2 gap-3 lg:gap-4">
                {technicalSkills.map((skill, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`bg-light-gray dark:bg-gray-800 p-3 lg:p-4 rounded-lg text-center hover:bg-navy dark:hover:bg-blue-600 hover:text-white transition-all duration-300 group border dark:border-gray-700 hover-lift ${
